...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/e3vpq9/TestLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'e3vpq9' => 'zhangyong@immotors.com' }
  s.source           = { :git => 'https://github.com/ericzhangyong/testLib.git', :tag => s.version.to_s }
